  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <div class="title-container">
        <h3 class="title">官渡区“政治生态”信息系统</h3>
      </div>
      ...
      <el-form-item prop="password">
        ...
        <el-input :key="passwordType" ref="password" v-model="loginForm.pwd" :type="passwordType" placeholder="Password"
  ...
  export default {
    ...
    methods: {
      ...
      success() {
        ...
        // if (originUrl == '') {
        //   console.log('originUrl == ' + this.redirect || '/');
      ...
      handleLogin() {
        ...
        this.$refs.loginForm.validate((valid) => {
          ...
          this.$login(this.loginForm.account, this.loginForm.pwd, this.success)
        })
      }
    }
  }
