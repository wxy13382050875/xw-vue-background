            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="籍贯">
                  <el-input v-model="form.NativePlace" maxlength="20" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="出生地">
                  <el-input v-model="form.BirthPlace" maxlength="20" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="入党时间">
                  <el-date-picker v-model="form.JoinTime" type="date" value-format="yyyy-MM-dd" placeholder="选择入党时间"
                    style="width: 100%;" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="参加工作时间">
                  <el-date-picker v-model="form.JobTime" value-format="yyyy-MM-dd" type="date" placeholder="选择参加工作时间"
                    style="width: 100%;" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="职务">
                  <el-input v-model="form.Job" maxlength="20" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="职称">
                  <el-input v-model="form.JobTitle" maxlength="10" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="分管工作">
                  <el-input v-model="form.JobCharge" maxlength="30" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="任职时间">
                  <el-date-picker v-model="form.NowJobTime" type="date" placeholder="选择参加工作时间" style="width: 100%;" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="16">
                <el-form-item label="全日制毕业院校系及专业">
                  <el-input v-model="form.FullEduCollege" maxlength="50" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="16">
                <el-form-item label="在职毕业院校系及专业">
                  <el-input v-model="form.JobEduCollege" maxlength="50" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-table border :data="form.PersonJob" style="margin-right: 1.875rem;">
                <el-table-column prop="StartTime" label="起始时间" style="width:6vw;">
                  <template scope="scope">
                    <el-date-picker v-model="scope.row.StartTime" type="date" value-format="yyyy-MM-dd" placeholder="选择开始时间"
                      style="width: 100%;" />
                  </template>
                </el-table-column>
                <el-table-column prop="EndTime" label="终止时间">
                  <template scope="scope">
                    <el-date-picker v-model="scope.row.EndTime" type="date" value-format="yyyy-MM-dd" placeholder="选择结束时间"
                      style="width: 100%;" />
                  </template>
                </el-table-column>
