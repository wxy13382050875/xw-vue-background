            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="姓别">
                  <el-select v-model="form.region" placeholder="请选择性别" style="width: 100%;">
                    <el-option v-for="(o, i) in $w.GetEnumArr('Gender')" :key="i" :value="o.value" :label="o.label"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="民族">
                  <el-select v-model="form.region" placeholder="请选择民族" style="width: 100%;">
                    <el-option v-for="(o, i) in $w.GetEnumArr('NationType')" :key="i" :value="o.value" :label="o.label"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="婚姻状况">
                  <el-select v-model="form.region" placeholder="请选择婚姻状况" style="width: 100%;">
                    <el-option v-for="(o, i) in $w.GetEnumArr('MarriageType')" :key="i" :value="o.value" :label="o.label"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item inline="true" label="文化程序">
                  <el-select v-model="form.region" placeholder="请选择文化程序" style="width: 100%;">
                    <el-option v-for="(o, i) in $w.GetEnumArr('CulturalType')" :key="i" :value="o.value" :label="o.label"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item inline="true" label="政治面貌">
                  <el-select v-model="form.region" placeholder="请选择政治面貌" style="width: 100%;">
                    <el-option v-for="(o, i) in $w.GetEnumArr('PolitOutlook')" :key="i" :value="o.value" :label="o.label"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="入党时间">
                  <el-date-picker v-model="form.date1" type="date" placeholder="选择入党时间" style="width: 100%;" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="参加工作时间">
                  <el-date-picker v-model="form.date1" type="date" placeholder="选择参加工作时间" style="width: 100%;" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="单位性质">
                  <el-select v-model="form.region" placeholder="请选择单位性质" style="width: 100%;">
                    <el-option v-for="(o, i) in $w.GetEnumArr('CompanyType')" :key="i" :value="o.value" :label="o.label"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="级别">
                  <el-select v-model="form.region" placeholder="请选择级别" style="width: 100%;">
                    <el-option v-for="(o, i) in $w.GetEnumArr('rankType')" :key="i" :value="o.value" :label="o.label"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="8">
      ...
      <div class="user-info-family">
        <el-form ref="inServForm" :model="inServForm" label-width="130px" size="small">
          <el-form-item label="家庭成员情况" prop="servin" label-width="120px">
            <template>
              <el-table border :data="infiledList" style="margin-right: 1.875rem;">
                <el-table-column prop="startTime" label="与本人关系" style="width:6vw;">
                  <template scope="scope">
                    <el-input v-model="scope.row.remark" size="mini" />
                  </template>
                </el-table-column>
                <el-table-column prop="endTime" label="姓名">
                  <template scope="scope">
                    <el-select v-model="form.region" placeholder="请选择亲属关系" style="width: 100%;">
                      <el-option v-for="(o, i) in $w.GetEnumArr('KindredType')" :key="i" :value="o.value" :label="o.label"></el-option>
                    </el-select>
                  </template>
                </el-table-column>
                <el-table-column prop="unit" label="政治面貌">
                  <template scope="scope">
                    <el-select v-model="form.region" placeholder="请选择政治面貌" style="width: 100%;">
                      <el-option v-for="(o, i) in $w.GetEnumArr('PolitOutlook')" :key="i" :value="o.value" :label="o.label"></el-option>
                    </el-select>
                ...
                <el-table-column prop="position" label="工作单位">
                  <template scope="scope">
                    <el-input v-model="scope.row.remark" size="mini" />
                  </template>
                </el-table-column>
